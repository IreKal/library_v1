    ...
    <nav class="black darken-3" role="navigation">
        <div class="nav-wrapper container">
            ...
            <ul class="right hide-on-med-and-down">
                ...
                <% } else { %>
                <li><a href="./mybooks"><i class="material-icons right">library_books</i> My Books</a></li>
            ...
            <ul id="nav-mobile" class="sidenav">
                ...
                <% } else { %>
                <li><a href="./mybooks"><i class="material-icons left">library_books</i> My Books</a></li>
